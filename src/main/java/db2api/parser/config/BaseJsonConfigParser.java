package db2api.parser.config;

import cn.hutool.json.JSONObject;
import db2api.model.ConfigModel;
import db2api.model.ConfigModel.OperationConfig;
import db2api.model.ConfigModel.UserConfig;
...
public class BaseJsonConfigParser extends ModelJsonParser<ConfigModel> {
    ...
    public ConfigModel parseJSON(JSONObject jsonObject) {
        ...
        for (int i = 0; i < arrayOperation.size(); i++) {
            ConfigModel.OperationConfig tmpopconfig = config_model.new OperationConfig();
